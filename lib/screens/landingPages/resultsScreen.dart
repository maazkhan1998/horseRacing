      ...
      body:SingleChildScrollView(
        child: Column(
          ...
          trailing: Container(
            ...
            child: Center(
              child: Icon(!isSecondTileOpened?Icons.add:Icons.remove,color:Colors.grey,size:30),
            ),
          ),
        ...
        ExpansionTile(
          ...
          trailing: Container(
            height:ScreenUtil().setHeight(30),width:ScreenUtil().setWidth(30),color:Colors.blue[900],
            child: Center(
              child: Icon(isFirstTileOpened?Icons.remove:Icons.add,color:Colors.grey,size:30),
            ),
          ),
        )),SizedBox(height:ScreenUtil().setHeight(10)),
          ],
