...
class _UserDetailScreenState extends State<UserDetailScreen> {
  ...
  TextEditingController phoneController=TextEditingController(text: '090078601');
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child:SingleChildScrollView(
          child: Container(
            padding: EdgeInsets.only(left:ScreenUtil().setWidth(20),right:ScreenUtil().setWidth(20),top:ScreenUtil().setHeight(60),),
            height: devHeight,
            width:devWidth,
            child: Column(
              children: [
                ...
                ),SizedBox(height:ScreenUtil().setHeight(40)),Text(_timeString,style:TextStyle(
